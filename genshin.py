...
class GenshinModule:
    ...
    def start_game(self):
        ...
        print("Starting Genshin...")
        keyboard.press('B')
        time.sleep(60)

        print("Logging into Genshin...")
        keyboard.press('A')
        time.sleep(60)
    ...
    def run_Genshin(self):
        time.sleep(1)
        with open("genshin-stamina.json") as rf: 
        ...
        print(f"\Genshin Module Execution Complete...\nTotal Time Taken: [{round(total_time, 2)}]")


# last key: X
if __name__ == "__main__":

    Genshin = GenshinModule()
    Genshin.run_Genshin()
